import os
import openai
from src.Models.completion_response import CompletionResponse
...
class OpenAIAPICaller:
    ...
    def get_response(self, question: str, context: [str] = None) -> CompletionResponse:
        try:
            if context is None:
            ...
            message_model = CompletionResponse(response_to_user)
            return message_model

        except openai.error.RateLimitError as exc:
            return CompletionResponse("ERROR: Rate limit exceeded. Please try again later.")
